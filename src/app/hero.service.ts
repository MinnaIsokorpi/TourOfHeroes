...
export class HeroService {
  //in-memory-web-api osoite, vaihda tähän oikea palvelimen osoite,
  //kun siirryt käyttämään oikeaa palvelinta
  private heroesUrl = 'api/heroes'; // URL to web api

  //määritteleeverkon yli kulkevan datan JSON-muotoiseksi
  httpOptions = {
  ...
  //yleisimmät metodit: get, post, put, delete
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    return (
      this.http
        ...
        // tässä ei tehdä mitään toimenpiteitä vaan tehdään vain lokitus
        //tekee vierheenkäsittelyn heti kun paluuarvo on tullut
        .pipe(
